...
// Задание 2
       ...
       System.out.println("3");
        ...
        UserList.add(new User("Asya","One",19));
        UserList.add(new User("Vanya","Two",19));
        UserList.add(new User("Petya","Three",20));

        System.out.println("------------------------------------------");

        System.out.println(UserList.contains(new User("Asya","One",19)));
        UserList.remove(new User("Asya","One",19));
        System.out.println(UserList.contains(new User("Asya","One",19)));

        System.out.println("------------------------------------------");

        List<User> UserList2 = new ArrayList<>();
        UserList2.add(new User("Vanya","Two",19));
        UserList2.add(new User("Petya","Three",20));
        ...
        System.out.println(Students1.contains(new Student("Asya","Shevchenko","ESTMu-19-1",5)));
        System.out.println(Students1.remove(new Student("Asya","Shevchenko","ESTMu-19-1",5)));
        System.out.println(Students1.contains(new Student("Asya","Shevchenko","ESTMu-19-1",5)));
